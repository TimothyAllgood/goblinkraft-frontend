...
const BASE_URL =
  "https://goblinkraft-backend-production.up.railway.app/api/v1/plothooks/data";
...
export default class PlotHookData {
  ...
  static getPlotHooks = async () => {
    let res = await axios.get(`${BASE_URL}/`);
    return res.data;
  };

  static getPlotHook = async (id) => {
    let res = await axios.get(`${BASE_URL}/${id}`);
    return res.data;
  };

  static deletePlotHook = async (id) => {

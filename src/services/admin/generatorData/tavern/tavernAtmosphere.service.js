...
const BASE_URL =
  "https://goblinkraft-backend-production.up.railway.app/api/v1/tavern/atmospheres";
...
export default class TavernAtmosphere {
  ...
  static getTavernAtmospheres = async () => {
    let res = await axios.get(`${BASE_URL}/`);
    return res.data;
  };

  static getTavernAtmosphere = async (id) => {
    let res = await axios.get(`${BASE_URL}/${id}`);
    return res.data;
  };

  static deleteTavernAtmosphere = async (id) => {
